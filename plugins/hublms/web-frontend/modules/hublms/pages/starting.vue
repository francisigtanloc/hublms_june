          ...
          <div class="main-header-logo">
            ...
            <div class="logo-header" data-background-color="dark">
              <a href="index.html" class="logo">
                <img
                  src="@hublms/assets/img/kaiadmin/logo_light.svg"
                  alt="navbar brand"
                  class="navbar-brand"
                  height="20"
                />
                    ...
                    <li>
                      <div class="message-notif-scroll scrollbar-outer">
                        <div class="notif-center">
                          <a href="#">
                            <div class="notif-img">
                              <img src="@hublms/assets/img/jm_denis.jpg" alt="Img Profile" />
                            </div>
                            ...
                            <tbody>
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="@hublms/assets/img/flags/id.png"
                                      alt="indonesia"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="@hublms/assets/img/flags/us.png"
                                      alt="united states"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="@hublms/assets/img/flags/au.png"
                                      alt="australia"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="@hublms/assets/img/flags/ru.png"
                                      alt="russia"
                                    />
                                  </div>
                                </td>
                  ...
                  <div class="card-body">
                    ...
                    <div class="card-list py-4">
                      <div class="item-list">
                        <div class="avatar">
                          <img
                            src="@hublms/assets/img/jm_denis.jpg"
                            alt="..."
                            class="avatar-img rounded-circle"
                          />
                          <img
                            :src="
                              require(`@hublms/assets/img/logoproduct2.svg`)
                            "
                          />
                        </div>

...
const logoHeaderContent = $('.sidebar .logo-header').html()
...
$(document).ready(function () {
  ...
  const toggle_quick_sidebar = false
  let toggle_topbar = false
  let minimize_sidebar = false
  let first_toggle_sidebar = false
  let toggle_page_sidebar = false
  const toggle_overlay_sidebar = false
  let nav_open = 0
  let quick_sidebar_open = 0
  let topbar_open = 0
  let mini_sidebar = 0
  let page_sidebar_open = 0
  let overlay_sidebar_open = 0
  ...
  if (!toggle_page_sidebar) {
    const pageSidebarToggler = $('.page-sidebar-toggler')
    ...
    const pageSidebarClose = $('.page-sidebar .back')
  ...
  if (!toggle_overlay_sidebar) {
    const overlaybutton = $('.sidenav-overlay-toggler')
...
// Sign In & Sign Up
const containerSignIn = $('.container-login')
const containerSignUp = $('.container-signup')
let showSignIn = true
